...
class ElcStrings {
  ...
  static const Map<String, Map<String, String>> _table = {
    ...
    'kmr': {
      ...
      'attach': 'فایل',
      'recordVoice': 'Peyama dengî tomar bike',
      'recordingVoice': 'Tê tomarkirin…',
      'discardVoice': 'Tomarkirinê jê bibe',
      'sendVoice': 'Peyama dengî bişîne',
      'micDenied': 'Ji bo tomarkirinê destûra mîkrofonê pêwîst e. Di mîhengan de destûrê bide û dîsa biceribîne.',
      'micFailed': 'Tomarkirin nehat destpêkirin. Ji kerema xwe dîsa biceribîne.',
      'attachImage': 'وێنە',
      'attachFile': 'فایل',
      'agentTyping': 'دنڤیسیت...',
