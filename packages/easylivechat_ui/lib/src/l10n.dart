...
class ElcStrings {
  ...
  static const Map<String, Map<String, String>> _table = {
    'en': {
      ...
      'closedNotice':
          "Our team is offline right now. Leave your message and we'll reply as soon as we're back.",
      'backAt': "We're back at {time}.",
      'noAgentsNotice':
          "Everyone's busy right now. Leave a message and we'll reply shortly.",
    ...
    'ar': {
      ...
      'closedNotice':
          'فريقنا غير متاح حالياً. اترك رسالتك وسنرد عليك فور عودتنا.',
    ...
    'ckb': {
      ...
      'closedNotice':
          'تیمەکەمان ئێستا لە دەرەوەی کارە. نامەکەت بەجێبهێڵە، هەرکە گەڕاینەوە وەڵامت دەدەینەوە.',
      'backAt': 'لە {time} دەگەڕێینەوە.',
      'noAgentsNotice':
          'ئێستا هەموو خەریکن. نامەیەک بەجێبهێڵە، بەم زووانە وەڵامت دەدەینەوە.',
    ...
    'de': {
      ...
      'closedNotice':
          'Unser Team ist gerade offline. Hinterlassen Sie Ihre Nachricht — wir antworten, sobald wir zurück sind.',
      'backAt': 'Wir sind ab {time} wieder da.',
      'noAgentsNotice':
          'Gerade sind alle beschäftigt. Hinterlassen Sie eine Nachricht — wir melden uns gleich.',
    ...
    'es': {
      ...
      'closedNotice':
          'Nuestro equipo no está disponible ahora. Deja tu mensaje y te responderemos en cuanto volvamos.',
      'backAt': 'Volvemos a las {time}.',
      'noAgentsNotice':
          'Ahora mismo todos están ocupados. Deja un mensaje y te responderemos en breve.',
      ...
      'closedReadOnly':
          'Nuestro equipo no está disponible ahora. Volvemos pronto.',
      'skipSurvey': 'Omitir',
      'closeChat': 'Cerrar',
    ...
    'fr': {
      ...
      'closedNotice':
          'Notre équipe est hors ligne pour le moment. Laissez votre message, nous répondrons dès notre retour.',
      'backAt': 'Nous revenons à {time}.',
      'noAgentsNotice':
          "Tout le monde est occupé pour l'instant. Laissez un message, nous répondrons vite.",
      ...
      'closedReadOnly':
          'Notre équipe est hors ligne pour le moment. Nous revenons bientôt.',
      'skipSurvey': 'Passer',
      'closeChat': 'Fermer',
    ...
    'hi': {
      ...
      'couldNotConnect':
          'कनेक्ट नहीं हो सका। कृपया अपना कनेक्शन जाँचें और पुनः प्रयास करें।',
      ...
      'closedNotice':
          'हमारी टीम अभी ऑफ़लाइन है। अपना संदेश छोड़ें, लौटते ही हम उत्तर देंगे।',
      'backAt': 'हम {time} बजे लौटते हैं।',
      'noAgentsNotice':
          'अभी सभी व्यस्त हैं। संदेश छोड़ें, हम जल्द उत्तर देंगे।',
    ...
    'it': {
      ...
      'closedNotice':
          'Il nostro team non è disponibile al momento. Lascia il tuo messaggio e ti risponderemo appena torniamo.',
      'backAt': 'Torniamo alle {time}.',
      'noAgentsNotice':
          'Al momento sono tutti occupati. Lascia un messaggio e ti risponderemo a breve.',
      ...
      'closedReadOnly':
          'Il nostro team non è disponibile al momento. Torniamo presto.',
      'skipSurvey': 'Salta',
      'closeChat': 'Chiudi',
    ...
    'kmr': {
      ...
      'couldNotConnect':
          'پەیوەندی نەهاتە کرن. هیڤیە پشتراستیێ ل هێلا ئنتێرنێتێ بکەی .',
      ...
      'closedNotice':
          'تیما مە نوکە بەردەستنینە. نەمایە خۆ بهێلە، دێ بزیترین دەم بەرسڤا تە هێتە دان پشتی تیم بەردەست دبیت.',
      'backAt': 'ئەم دێ د {time} دا ڤەدگەڕین.',
      'noAgentsNotice':
          'د نوکە دا تیم یا ب کارە. نامەیێ بهێلە، دێ ب زویترین دەم بەرسڤ هێتە دان.',
      ...
      'closedReadOnly':
          'تیما مە نوکە بەردەست نینە ، نێزیک دێ هێنە د خزمەتا وەدا.',
      'skipSurvey': 'ببورینە',
      'closeChat': 'گرتن',
    ...
    'pt': {
      ...
      'closedNotice':
          'A nossa equipa está offline neste momento. Deixe a sua mensagem e responderemos assim que voltarmos.',
      'backAt': 'Voltamos às {time}.',
      'noAgentsNotice':
          'Estamos todos ocupados neste momento. Deixe uma mensagem e responderemos em breve.',
      ...
      'exitChatCancel': 'Cancelar',
      'closedReadOnly':
          'A nossa equipa está offline neste momento. Voltamos em breve.',
      'skipSurvey': 'Ignorar',
      'closeChat': 'Fechar',
    ...
    'tr': {
      ...
      'couldNotConnect':
          'Bağlanılamadı. Bağlantınızı kontrol edip tekrar deneyin.',
      ...
      'closedNotice':
          'Ekibimiz şu anda çevrimdışı. Mesajınızı bırakın, döndüğümüzde hemen yanıtlayalım.',
      'backAt': '{time} itibarıyla döneriz.',
      'noAgentsNotice':
          'Şu anda herkes meşgul. Mesaj bırakın, kısa sürede dönelim.',
      ...
      'closedReadOnly':
          'Ekibimiz şu anda çevrimdışı. Kısa süre içinde döneceğiz.',
      'skipSurvey': 'Atla',
      'closeChat': 'Kapat',
    ...
    'ur': {
      ...
      'couldNotConnect':
          'کنکشن نہیں ہو سکا۔ اپنا کنکشن چیک کریں اور دوبارہ کوشش کریں۔',
      ...
      'closedNotice':
          'ہماری ٹیم اس وقت آف لائن ہے۔ اپنا پیغام چھوڑ دیں، واپس آتے ہی جواب دیں گے۔',
      'backAt': 'ہم {time} بجے واپس آتے ہیں۔',
      'noAgentsNotice':
          'اس وقت سب مصروف ہیں۔ پیغام چھوڑیں، ہم جلد جواب دیں گے۔',
