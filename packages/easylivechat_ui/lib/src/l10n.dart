...
class ElcStrings {
  ...
  String get recordVoice => _t('recordVoice');
  String get recordingVoice => _t('recordingVoice');
  String get discardVoice => _t('discardVoice');
  String get sendVoice => _t('sendVoice');
  String get micDenied => _t('micDenied');
  String get micFailed => _t('micFailed');

  /// What a received voice note is, shown until it has been played once and
  /// its length is known. See `views/voice_note_tile.dart` for why the
  /// duration is not read up front.
  String get voiceMessage => _t('voiceMessage');
  String get playVoice => _t('playVoice');
  String get pauseVoice => _t('pauseVoice');
  String get attachImage => _t('attachImage');
  String get attachFile => _t('attachFile');
  String get agentTyping => _t('agentTyping');

  /// The typing row while the AI assistant composes a reply.
  String get assistantTyping => _t('assistantTyping');

  /// Beside the sender name on every assistant message.
  String get aiBadge => _t('aiBadge');

  /// Replace [closedNotice] / [noAgentsNotice] while the assistant is answering:
  /// "leave a message and we'll reply when we're back" is untrue when a reply
  /// arrives in seconds.
  String get closedAssistantNotice => _t('closedAssistantNotice');
  String get noAgentsAssistantNotice => _t('noAgentsAssistantNotice');
  ...
  /// Screen-reader labels for the tick on the visitor's own message. The tick
  /// is the whole visual, so without these it is announced as nothing at all.
  ...
  static const Map<String, Map<String, String>> _table = {
    'en': {
      ...
      'micDenied': 'We need microphone access to record. Allow it in your settings, then try again.',
      'micFailed': "The recording couldn't be started. Please try again.",
      'attachImage': 'Photo',
      'attachFile': 'File',
      'agentTyping': 'Typing…',
      ...
      'aiBadge': 'AI',
      'closedAssistantNotice': 'Our team is offline right now, but our assistant can help you in the meantime.',
      'noAgentsAssistantNotice': "Everyone's busy right now, but our assistant can help you in the meantime.",
    ...
    'ar': {
      ...
      'discardVoice': 'تجاهل التسجيل',
      'sendVoice': 'إرسال الرسالة الصوتية',
      'voiceMessage': 'رسالة صوتية',
      'playVoice': 'تشغيل الرسالة الصوتية',
      'pauseVoice': 'إيقاف الرسالة الصوتية مؤقتًا',
      'micDenied': 'نحتاج إذن الميكروفون للتسجيل. فعّله من الإعدادات ثم أعد المحاولة.',
      'micFailed': 'تعذّر بدء التسجيل. يُرجى المحاولة مرة أخرى.',
      'attachImage': 'صورة',
      'attachFile': 'ملف',
      'agentTyping': 'يكتب…',
      ...
      'closedAssistantNotice': 'فريقنا غير متاح حالياً، لكن مساعدنا يمكنه مساعدتك في هذه الأثناء.',
      'noAgentsAssistantNotice': 'الجميع مشغول حالياً، لكن مساعدنا يمكنه مساعدتك في هذه الأثناء.',
    ...
    'ckb': {
      ...
      'attach': 'هاوپێچکردن',
      'recordVoice': 'تۆمارکردنی پەیامی دەنگی',
      'recordingVoice': 'تۆمار دەکرێت…',
      'discardVoice': 'پشتگوێخستنی تۆمارەکە',
      'sendVoice': 'ناردنی پەیامی دەنگی',
      'voiceMessage': 'پەیامی دەنگی',
      'playVoice': 'لێدانی پەیامی دەنگی',
      'pauseVoice': 'وەستاندنی پەیامی دەنگی',
      'micDenied': 'بۆ تۆمارکردن پێویستمان بە ڕێگەپێدانی مایکرۆفۆنە. لە ڕێکخستنەکان چالاکی بکە و دووبارە هەوڵ بدەرەوە.',
      'micFailed': 'نەتوانرا تۆمارکردن دەست پێ بکات. تکایە دووبارە هەوڵ بدەرەوە.',
      'attachImage': 'وێنە',
      'attachFile': 'فایل',
      ...
      'aiBadge': 'AI',
      'closedAssistantNotice': 'تیمەکەمان ئێستا دەرەوەی کارە، بەڵام یاریدەدەرەکەمان دەتوانێت لەم ماوەیەدا یارمەتیت بدات.',
      'noAgentsAssistantNotice': 'ئێستا هەموو خەریکن، بەڵام یاریدەدەرەکەمان دەتوانێت لەم ماوەیەدا یارمەتیت بدات.',
    ...
    'de': {
      ...
      'pauseVoice': 'Sprachnachricht pausieren',
      'micDenied': 'Wir brauchen Mikrofonzugriff für die Aufnahme. Erlauben Sie ihn in den Einstellungen und versuchen Sie es erneut.',
      'micFailed': 'Die Aufnahme konnte nicht gestartet werden. Bitte erneut versuchen.',
      'attachImage': 'Foto',
      'attachFile': 'Datei',
      ...
      'aiBadge': 'KI',
      'closedAssistantNotice': 'Unser Team ist gerade offline, aber unser Assistent hilft Ihnen in der Zwischenzeit gern.',
      'noAgentsAssistantNotice': 'Gerade sind alle beschäftigt, aber unser Assistent hilft Ihnen in der Zwischenzeit gern.',
    ...
    'es': {
      ...
      'recordingVoice': 'Grabando…',
      'discardVoice': 'Descartar la grabación',
      'sendVoice': 'Enviar mensaje de voz',
      'voiceMessage': 'Mensaje de voz',
      'playVoice': 'Reproducir mensaje de voz',
      'pauseVoice': 'Pausar mensaje de voz',
      'micDenied': 'Necesitamos acceso al micrófono para grabar. Permítelo en los ajustes e inténtalo de nuevo.',
      'micFailed': 'No se pudo iniciar la grabación. Inténtalo de nuevo.',
      'attachImage': 'Foto',
      'attachFile': 'Archivo',
      ...
      'aiBadge': 'IA',
      'closedAssistantNotice': 'Nuestro equipo no está disponible ahora, pero nuestro asistente puede ayudarte mientras tanto.',
      'noAgentsAssistantNotice': 'Ahora mismo todos están ocupados, pero nuestro asistente puede ayudarte mientras tanto.',
    ...
    'fr': {
      ...
      'discardVoice': 'Supprimer l’enregistrement',
      'sendVoice': 'Envoyer le message vocal',
      'voiceMessage': 'Message vocal',
      'playVoice': 'Lire le message vocal',
      'pauseVoice': 'Mettre le message vocal en pause',
      'micDenied': 'Nous avons besoin du micro pour enregistrer. Autorisez-le dans les réglages, puis réessayez.',
      'micFailed': 'L’enregistrement n’a pas pu démarrer. Veuillez réessayer.',
      'attachImage': 'Photo',
      'attachFile': 'Fichier',
      ...
      'aiBadge': 'IA',
      'closedAssistantNotice': 'Notre équipe est hors ligne pour le moment, mais notre assistant peut vous aider en attendant.',
      'noAgentsAssistantNotice': "Tout le monde est occupé pour l'instant, mais notre assistant peut vous aider en attendant.",
    ...
    'hi': {
      ...
      'discardVoice': 'रिकॉर्डिंग हटाएँ',
      'sendVoice': 'वॉइस संदेश भेजें',
      'voiceMessage': 'वॉइस संदेश',
      'playVoice': 'वॉइस संदेश चलाएँ',
      'pauseVoice': 'वॉइस संदेश रोकें',
      'micDenied': 'रिकॉर्ड करने के लिए हमें माइक्रोफ़ोन की अनुमति चाहिए। सेटिंग्स में अनुमति दें और फिर कोशिश करें।',
      'micFailed': 'रिकॉर्डिंग शुरू नहीं हो सकी। कृपया फिर से कोशिश करें।',
      'attachImage': 'फ़ोटो',
      'attachFile': 'फ़ाइल',
      ...
      'aiBadge': 'एआई',
      'closedAssistantNotice': 'हमारी टीम अभी ऑफ़लाइन है, लेकिन तब तक हमारा सहायक आपकी मदद कर सकता है।',
      'noAgentsAssistantNotice': 'अभी सभी व्यस्त हैं, लेकिन तब तक हमारा सहायक आपकी मदद कर सकता है।',
      'assistantTyping': 'सहायक लिख रहा है…',
    ...
    'it': {
      ...
      'recordingVoice': 'Registrazione…',
      'discardVoice': 'Elimina la registrazione',
      'sendVoice': 'Invia messaggio vocale',
      'voiceMessage': 'Messaggio vocale',
      'playVoice': 'Riproduci messaggio vocale',
      'pauseVoice': 'Metti in pausa il messaggio vocale',
      'micDenied': 'Serve l’accesso al microfono per registrare. Consentilo nelle impostazioni e riprova.',
      'micFailed': 'Non è stato possibile avviare la registrazione. Riprova.',
      'attachImage': 'Foto',
      'attachFile': 'File',
      ...
      'aiBadge': 'IA',
      'closedAssistantNotice': 'Il nostro team non è disponibile al momento, ma nel frattempo il nostro assistente può aiutarti.',
      'noAgentsAssistantNotice': 'Al momento sono tutti occupati, ma nel frattempo il nostro assistente può aiutarti.',
    ...
    'kmr': {
      ...
      'attach': 'فایل',
      'recordVoice': 'تۆمارکرنا نامەیا دەنگی',
      'recordingVoice': 'دهێتە تۆمارکرن',
      'discardVoice': 'ژێبرنا نامەیا دەنگی',
      'sendVoice': 'هنارتنا نامەیا دەنگی',
      'voiceMessage': 'نامەیا دەنگی',
      'playVoice': 'دانە شولی نامەیا دەنگی',
      'pauseVoice': 'راوەستاندا نامەیا دەنگی',
      'micDenied': 'بۆ تۆمارکرنێ پێدڤییە دەستهەلا مایکروفۆنی بدەیە ئەپلیکەیشنی. د ڕێکخستنان دا چالاک بکە و دووبارە هەوڵ بدە.',
      'micFailed': 'نەهاتە تۆمارکرن. هیڤییە دووبارە هەوڵ بدە.',
      'attachImage': 'وێنە',
      'attachFile': 'فایل',
      'agentTyping': 'دنڤیسیت...',
      'loadOlder': 'نامەیێن کەڤن دیاربکە',
      ...
      'retry': 'دووبارە هەولبدە',
      'couldNotConnect': 'پەیوەندی نەهاتە کرن. هیڤیە پشتراستیێ ل هێلا ئنتێرنێتێ بکەی .',
      'rateYourChat': 'گفتووگۆیێ ب هەلسەنگینە',
      'rateHint': 'گفتووگۆ چاوا بوو؟',
      'addAComment': 'تێبینیەکێ زێدە بکە (هەلبژارتی)',
      'submit': 'پەسەندکرن',
      'thanksForFeedback': 'سوپاس بۆ بۆچوونا تە',
      'yourName': 'ناڤێ تە',
      'yourEmail': 'ئیمەیلێ تە',
      'yourMessage': 'نامەیا تە',
      'sendMessage': 'نامەیێ فرێکە',
      'closedNotice': 'تیما مە نوکە بەردەستنینە. نەمایە خۆ بهێلە، دێ بزیترین دەم بەرسڤا تە هێتە دان پشتی تیم بەردەست دبیت.',
      'backAt': 'ئەم دێ د {time} دا ڤەدگەڕین.',
      'noAgentsNotice': 'د نوکە دا تیم یا ب کارە. نامەیێ بهێلە، دێ ب زویترین دەم بەرسڤ هێتە دان.',
      'aiBadge': 'AI',
      'closedAssistantNotice': 'تیما مە نوکە بەردەستنینە، بەلێ هاریکارێ مە دشێت د ڤێ ناڤبەرێ دا هاریکاریا تە بکەت.',
      'noAgentsAssistantNotice': 'د نوکە دا تیم یا ب کارە، بەلێ هاریکارێ مە دشێت د ڤێ ناڤبەرێ دا هاریکاریا تە بکەت.',
      'assistantTyping': 'هاریکار دنڤیسیت…',
      'closedForLabel': 'ژ ئەگەرێ {label} تیم یا بەردەست نینە.',
      'unavailableTitle': 'تیم نەیا بەردەستە',
      'offlineThanks': 'سوپاس! نێزیک دێ هێینە خزمەتا تە .',
      'exitChatTitle': 'پشتراستی تە دڤێت ڤێ چاتی بگری؟',
      'exitChatConfirm': 'چاتی بگرە',
      'exitChatCancel': 'ڤەگەریان',
      'closedReadOnly': 'تیما مە نوکە بەردەست نینە ، نێزیک دێ هێنە د خزمەتا وەدا.',
      'skipSurvey': 'ببورینە',
      'closeChat': 'گرتن',
      'systemTransferredTo': 'چات هاتە ڤەگوهاستن بۆ {name}',
      'systemSessionEnded': 'گفتوگو ب دوماهی هات. {date}',
      'systemSessionStarted': 'گفتوگویەکا نوی. {date}',
      'endChat': 'ب دوماهیک ئینانا چاتی',
      'systemSessionLeft': 'هاتیە ئەرشیفکرن - تو ژ چاتی دەرکەتی. {time}',
      'postChatTitle': 'فورما پشتی چاتی',
    },
    'pt': {
      'send': 'Enviar',
      ...
      'recordingVoice': 'A gravar…',
      'discardVoice': 'Descartar a gravação',
      'sendVoice': 'Enviar mensagem de voz',
      'voiceMessage': 'Mensagem de voz',
      'playVoice': 'Reproduzir mensagem de voz',
      'pauseVoice': 'Pausar mensagem de voz',
      'micDenied': 'Precisamos de acesso ao microfone para gravar. Permita nas definições e tente novamente.',
      'micFailed': 'Não foi possível iniciar a gravação. Tente novamente.',
      'attachImage': 'Foto',
      'attachFile': 'Arquivo',
      ...
      'aiBadge': 'IA',
      'closedAssistantNotice': 'A nossa equipa está offline neste momento, mas o nosso assistente pode ajudar entretanto.',
      'noAgentsAssistantNotice': 'Estamos todos ocupados neste momento, mas o nosso assistente pode ajudar entretanto.',
    ...
    'tr': {
      ...
      'playVoice': 'Sesli mesajı oynat',
      'pauseVoice': 'Sesli mesajı duraklat',
      'micDenied': 'Kayıt için mikrofon erişimine ihtiyacımız var. Ayarlardan izin verip yeniden deneyin.',
      'micFailed': 'Kayıt başlatılamadı. Lütfen tekrar deneyin.',
      ...
      'aiBadge': 'Yapay zekâ',
      'closedAssistantNotice': 'Ekibimiz şu anda çevrimdışı, ama bu arada asistanımız size yardımcı olabilir.',
      'noAgentsAssistantNotice': 'Şu anda herkes meşgul, ama bu arada asistanımız size yardımcı olabilir.',
    ...
    'ur': {
      ...
      'attach': 'منسلک کریں',
      'recordVoice': 'صوتی پیغام ریکارڈ کریں',
      'recordingVoice': 'ریکارڈنگ جاری ہے…',
      'discardVoice': 'ریکارڈنگ حذف کریں',
      'sendVoice': 'صوتی پیغام بھیجیں',
      'voiceMessage': 'صوتی پیغام',
      'playVoice': 'صوتی پیغام چلائیں',
      'pauseVoice': 'صوتی پیغام روکیں',
      'micDenied': 'ریکارڈ کرنے کے لیے ہمیں مائیکروفون کی اجازت درکار ہے۔ سیٹنگز میں اجازت دیں اور دوبارہ کوشش کریں۔',
      'micFailed': 'ریکارڈنگ شروع نہیں ہو سکی۔ براہِ کرم دوبارہ کوشش کریں۔',
      'attachImage': 'تصویر',
      'attachFile': 'فائل',
      ...
      'aiBadge': 'اے آئی',
      'closedAssistantNotice': 'ہماری ٹیم اس وقت آف لائن ہے، لیکن اس دوران ہمارا معاون آپ کی مدد کر سکتا ہے۔',
      'noAgentsAssistantNotice': 'اس وقت سب مصروف ہیں، لیکن اس دوران ہمارا معاون آپ کی مدد کر سکتا ہے۔',
    ...
    'zh': {
      ...
      'playVoice': '播放语音消息',
      'pauseVoice': '暂停语音消息',
      'micDenied': '录音需要麦克风权限。请在设置中允许后重试。',
      'micFailed': '无法开始录音，请重试。',
      'attachImage': '照片',
      'attachFile': '文件',
      'agentTyping': '正在输入…',
      'loadOlder': '加载更早的消息',
      ...
      'aiBadge': 'AI',
      'closedAssistantNotice': '我们的团队当前不在线，但在此期间我们的助手可以为你提供帮助。',
      'noAgentsAssistantNotice': '目前大家都在忙，但在此期间我们的助手可以为你提供帮助。',
